...
var servicesList = []components.Service{
	{
		...
		Gallery: []string{"IMG_0240.JPG", "IMG_0243.JPG", "IMG_9886.JPG", "IMG_9887.JPG"},
	},
	{
		Slug:        "antichrome",
		Title:       "Антихром",
		...
		Gallery: []string{"IMG_0353.JPG", "IMG_0356.JPG", "IMG_0370.JPG", "IMG_0372.JPG"},
	},
	{
		Slug:        "polishing",
		Title:       "Полировка ЛКП",
		...
		Steps: []components.Step{
			...
			{Title: "Мойка и деконтаминация", Description: "Двухфазная мойка, очистка глиной от вкраплений, маскировка элементов"},
		...
		Gallery: []string{"FullSizeRender.JPG", "FullSizeRender 2.JPG", "IMG_1845.JPG", "IMG_1848.JPG"},
	},
	{
		Slug:        "optics",
		Title:       "Полировка оптики",
		Subtitle:    "Восстановление прозрачности фар и фонарей",
		...
		Gallery: []string{"IMG_1850.JPG", "IMG_1848.JPG", "IMG_0353.JPG", "IMG_0356.JPG"},
	},
	{
		Slug:        "coatings",
		Title:       "Защитные покрытия",
		Subtitle:    "Керамика, полимер, кварц — долговременная защита",
		Description: "Нанесение профессиональных защитных составов на кузов автомобиля. Керамическое покрытие создаёт прочный гидрофобный слой, защищающий ЛКП от ультрафиолета, реагентов и мелких царапин. Гарантия до 24 месяцев.",
		HeroImage:   "IMG_1850.JPG",
		Tags:        []string{"Керамика", "Полимерное покрытие", "Кварцевое покрытие", "Жидкое стекло", "Гидрофобное покрытие"},
		Steps: []components.Step{
			...
			{Title: "Нанесение покрытия", Description: "Послойное нанесение керамического/кварцевого состава"},
			{Title: "ИК-сушка и полимеризация", Description: "Принудительная сушка инфракрасной лампой для максимальной твёрдости"},
		},
		Prices: []components.Price{
			{Name: "Керамика (1 слой)", Price: "от 15 000 ₽"},
			{Name: "Керамика (2 слоя)", Price: "от 25 000 ₽"},
			{Name: "Кварцевое покрытие", Price: "от 20 000 ₽"},
			{Name: "Жидкое стекло", Price: "от 10 000 ₽"},
		},
		Gallery: []string{"IMG_1850.JPG", "IMG_9888.JPG", "IMG_9889.JPG", "IMG_7242.JPG"},
	},
	{
		Slug:        "cleaning",
		...
		Gallery: []string{"IMG_6183.jpg", "IMG_6185.jpg", "IMG_6186.jpg", "IMG_6187.jpg"},
	},
	{
		...
		Gallery: []string{"IMG_6188.jpg", "IMG_6189.jpg", "IMG_6190.jpg", "IMG_6185.jpg"},
	},
	{
		Slug:        "partial-cleaning",
		Title:       "Химчистка отдельных элементов",
		Subtitle:    "Точечная чистка: потолок, сиденье, багажник",
		Description: "Не нужна полная химчистка? Чистим отдельные элементы: водительское сиденье, потолок, коврики, багажник, детское кресло. Оперативно и без лишних затрат.",
		HeroImage:   "IMG_6186.jpg",
		Tags:        []string{"Одно сиденье", "Потолок", "Коврики", "Багажник", "Дверные карты", "Руль"},
		Steps: []components.Step{
			{Title: "Осмотр загрязнения", Description: "Определяем тип пятна и подбираем оптимальный состав"},
			{Title: "Обработка", Description: "Нанесение состава, работа щёткой или торнадором"},
			{Title: "Экстракция", Description: "Вытягивание грязи экстрактором до чистого состояния"},
			{Title: "Сушка", Description: "Сушка элемента, проверка результата"},
		},
		Prices: []components.Price{
			{Name: "Одно сиденье", Price: "от 2 500 ₽"},
			{Name: "Потолок", Price: "от 3 000 ₽"},
			{Name: "Багажник", Price: "от 2 000 ₽"},
			{Name: "Дверные карты (4 шт)", Price: "от 4 000 ₽"},
		},
		Gallery: []string{"IMG_6186.jpg", "IMG_6183.jpg", "IMG_6190.jpg", "IMG_6189.jpg"},
	},
	{
		Slug:        "soundproofing",
		...
		Gallery: []string{"IMG_7242.JPG", "IMG_7716.JPG", "IMG_3592.JPG", "IMG_2926.JPG"},
	},
}
...
var casesList = []components.Case{
	{
		...
		HeroImage: "IMG_0243.JPG",
		BeforeImg: "FullSizeRender 21.JPG",
		AfterImg:  "FullSizeRender 11.JPG",
		Works: []components.Step{
			{Title: "Замер толщины ЛКП", Description: "Диагностика толщиномером всех панелей кузова"},
			{Title: "Подготовка", Description: "Мойка, деконтаминация, маскировка пластика и резинок"},
		...
		Gallery: []string{"IMG_0243.JPG", "IMG_0244.JPG", "IMG_0245.JPG", "IMG_0241.JPG"},
	},
	{
		Slug:      "dodge-ram",
		Car:       "Dodge RAM",
