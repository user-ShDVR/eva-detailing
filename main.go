...
var servicesList = []components.Service{
	...
	},
	{
		Slug:        "antichrome",
		Title:       "Антихром",
		Subtitle:    "Оклейка и покраска хромированных элементов в чёрный",
		Description: "Оклейка и покраска хромированных деталей кузова виниловой или полиуретановой плёнкой. Радиаторная решётка, молдинги, рейлинги, оконные рамки — всё приобретает строгий чёрный вид. Защита от коррозии и царапин в комплекте.",
		HeroImage:   "IMG_0353.webp",
		Tags:        []string{"Решётка радиатора", "Молдинги", "Рейлинги", "Оконные рамки", "Эмблемы", "Зеркала"},
		Steps: []components.Step{
			{Title: "Демонтаж элементов", Description: "Аккуратный демонтаж хромированных деталей для качественной оклейки/покраски"},
